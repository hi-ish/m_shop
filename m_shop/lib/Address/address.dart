...
import 'package:m_shop/Models/address.dart';
import 'package:m_shop/Orders//placeOrderPayment.dart';
import 'package:m_shop/Orders/OrderDetailsPage.dart';
import 'package:m_shop/Widgets/customAppBar.dart';
import 'package:m_shop/Widgets/loadingWidget.dart';
import 'package:m_shop/Widgets/wideButton.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
                'Please add your shipment address so that we can deliver your product.'),
          ],
        ),
      ),
    );
